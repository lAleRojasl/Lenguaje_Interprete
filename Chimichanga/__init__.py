import Chimichanga.parser as p
import Chimichanga.ast
import Chimichanga.environment
...
def execute(source, filename, data_log: bool=False, disable_warnings: bool=True):
    ...
    try:
        ...
        environment.declare_env(Chimichanga.ast.symbols)
        ...
        if data_log:
            ...
            with open(name, 'wt') as archivo_log:
                ...
                pprint(Chimichanga.ast.symbols.table(), stream=archivo_log)           
            archivo_log.close()
